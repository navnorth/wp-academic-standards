  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" id="btnUpdateStandards" class="btn btn-default btn-sm btn-primary" data-postid="<?php if (is_object($post)) echo $post->ID; ?>" data-dismiss="modal">Update</button>
      </div>
    </div>
  </div>
</div>